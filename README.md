...
→ [`policy-as-code-demo`](https://github.com/CodisTech/policy-as-code-demo) — OPA/Rego + InSpec, framework-mapped, CI-tested
...
→ [`security-architecture`](https://github.com/CodisTech/security-architecture) — zero-trust design, firewall model, DR/resilience, decision records
